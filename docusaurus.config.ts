...
const config: Config = {
  ...
  url: 'https://anhtran8301.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/ddc-property-blog/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'anhtran8301', // Usually your GitHub org/user name.
  projectName: 'ddc-property-blog', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/anhtran8301/ddc-property-blog/tree/main/',
        },
        blog: {
